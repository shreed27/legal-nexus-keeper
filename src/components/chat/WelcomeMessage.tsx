...
const WelcomeMessage = () => {
  return (
    <div className="text-center text-neutral-400 mt-8 space-y-4">
      <Bot className="w-12 md:w-16 h-12 md:h-16 mx-auto mb-4 text-primary animate-pulse" />
      <h2 className="text-xl md:text-2xl font-semibold mb-2 text-white">Welcome to AVENIX.PRO Legal Assistant</h2>
